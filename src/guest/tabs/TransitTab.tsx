...
const mapWalkingUrl = (origin: string, destination: string) => {
      ...
      <div className="glass-card">
        ...
        <div className="airport-map-actions">
          {transitPlaces.map((place) => (
            <a
              key={place.label}
              href={mapWalkingUrl(stayAddress, place.query)}
              target="_blank"
              rel="noreferrer"
              className="map-btn"
            >
        ...
        <div className="map-location-links">
          <span>只想查看位置：</span>
          <a href={mapSearchUrl(stayAddress)} target="_blank" rel="noreferrer">住宿</a>
        ...
        <ul className="bullet-list">
          <li>
            <div>
              ...
              <a href={mapWalkingUrl(stayAddress, '都営浅草線 蔵前駅')} target="_blank" rel="noreferrer" className="map-btn station-walking-link">
                📍 住宿 → 淺草線・藏前站
              </a>
            </div>
          </li>
          <li>
            <div>
              ...
              <a href={mapWalkingUrl(stayAddress, '都営大江戸線 蔵前駅')} target="_blank" rel="noreferrer" className="map-btn station-walking-link">
                📍 住宿 → 大江戶線・藏前站
              </a>
            </div>
          </li>
          <li>
            <div>
              ...
              <a href={mapWalkingUrl(stayAddress, '東京メトロ 田原町駅')} target="_blank" rel="noreferrer" className="map-btn station-walking-link">
                📍 住宿 → 田原町站
              </a>
            </div>
          </li>
        ...
        <ul className="bullet-list">
          <li>
            <div>
              ...
              <a href={mapWalkingUrl(stayAddress, KOTOBUKI_SANCHO_BUS_STOP)} target="_blank" rel="noreferrer" className="map-btn station-walking-link">
                🚌 住宿 → 都 02 上車點：壽三丁目
              </a>
              ...
              <a href={mapWalkingUrl(stayAddress, '蔵前駅前 バス停')} target="_blank" rel="noreferrer" className="map-btn station-walking-link">
                🚌 住宿 → 藏前站前公車站
              </a>
