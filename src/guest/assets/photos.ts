export const arrivalPhotos = {
  ...
  livingRoom: [
    ...
    new URL('./arrival/IMG_3350.jpg', import.meta.url).href,
  ],
  bedroom: [new URL('./arrival/IMG_3340.jpg', import.meta.url).href],
  bathroom: [
    new URL('./arrival/IMG_3332.jpg', import.meta.url).href,
    new URL('./arrival/IMG_3333.jpg', import.meta.url).href,
  ],
  kitchenDetails: [
    new URL('./arrival/IMG_3345.jpg', import.meta.url).href,
    new URL('./arrival/IMG_3344.jpg', import.meta.url).href,
    new URL('./arrival/IMG_3346.jpg', import.meta.url).href,
    new URL('./arrival/IMG_3342.jpg', import.meta.url).href,
  ],
  cabinetDetails: [
    new URL('./arrival/IMG_3335.jpg', import.meta.url).href,
    new URL('./arrival/IMG_3338.jpg', import.meta.url).href,
    new URL('./arrival/IMG_3336.jpg', import.meta.url).href,
  ],
  shoeCabinet: [new URL('./arrival/IMG_3322.jpg', import.meta.url).href],
};
